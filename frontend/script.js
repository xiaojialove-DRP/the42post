...
const I18N = {
  en: {
    ...
    btn_about: 'ABOUT',
    footer_about_text: 'AI learns from what we write. We\'re here to teach it what we feel — the taste, the instinct, the unsaid.',
    ...
    footer_step_1: 'You share an instinct',
    footer_step_2: 'We forge it into a skill',
    footer_step_3: 'AI learns from you',
  ...
  cn: {
    ...
    btn_about: '关于',
    footer_about_text: 'AI 学的是我们写下的。我们想教它感受——那些品位、直觉，与不言自明的部分。',
    about_main_text: '一个所有人都可以参与AI价值观塑造的开放研究社区。',
    btn_howto: '如何开始',
    footer_step_1: '你分享一份直觉',
    footer_step_2: '我们把它锻造成技能',
    footer_step_3: 'AI 向你学习',
