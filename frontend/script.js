...
const I18N = {
  en: {
    ...
    forge_layer_subtitle_1: "What's the core principle?",
    forge_layer_2: '02  INSTANTIATING',
    forge_layer_subtitle_2: 'Before / After examples',
    forge_layer_3: '03  FENCING',
    forge_layer_subtitle_3: 'When does it apply?',
    forge_layer_4: '04  VALIDATING',
    forge_layer_subtitle_4: 'How do we know it works?',
    forge_layer_5: '05  CONTEXTUALIZING',
    forge_layer_subtitle_5: 'Across cultural contexts',
  ...
  cn: {
    ...
    forge_layer_1: '01  定义',
    forge_layer_subtitle_1: '核心原则是什么',
    forge_layer_2: '02  场景举例',
    forge_layer_subtitle_2: 'Before / After 对比',
    forge_layer_3: '03  边界定义',
    forge_layer_subtitle_3: '什么时候适用',
    forge_layer_4: '04  验证测试',
    forge_layer_subtitle_4: '怎么知道它有效',
    forge_layer_5: '05  文化适配',
    forge_layer_subtitle_5: '不同文化背景下',
    forge_ready: '准备铸造',
    forge_proceed: '继续发布 →',
