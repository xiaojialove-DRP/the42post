...
const I18N = {
  en: {
    ...
    chat_bubble_invite: 'This is a small tool that helps you turn your thoughts, ideas, and opinions into a Skill—a personal thinking module of your own. We welcome everyone to share human intuition, unconventional wisdom, and aesthetic taste. Once created, test your Skill directly in the Playground to see how it shapes AI\'s responses.',
  ...
  cn: {
    ...
    chat_bubble_invite: '这是一个小工具，它能让你把自己的思考、想法和意见一步步制作成一个 Skill ——一个属于你个人的思维模块。我们欢迎所有人分享人类的超常识和直觉审美。制作完成后，你可以直接在"游乐场"里测试这个 Skill 会如何影响 AI 的回答。',
