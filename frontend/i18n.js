...
const I18N = {
  en: {
    ...
    forge_layer_subtitle_1: 'Finding the one stance worth keeping',
    forge_layer_2: '02  INSTANTIATING',
    forge_layer_subtitle_2: 'One right example, one that misses',
    forge_layer_3: '03  FENCING',
    forge_layer_subtitle_3: "When it applies, when it doesn't",
    forge_layer_4: '04  VALIDATING',
    forge_layer_subtitle_4: "How to tell it's actually working",
    forge_layer_5: '05  CONTEXTUALIZING',
    forge_layer_subtitle_5: 'How this shifts across cultures',
    ...
    card_soul_hash_label: 'Soul-Hash',
  ...
  cn: {
    ...
    forge_layer_1: '01  定义',
    forge_layer_subtitle_1: '提炼这条直觉的核心立场',
    forge_layer_2: '02  场景举例',
    forge_layer_subtitle_2: '一个对的例子，一个走样的例子',
    forge_layer_3: '03  边界定义',
    forge_layer_subtitle_3: '什么时候该用，什么时候不该用',
    forge_layer_4: '04  验证测试',
    forge_layer_subtitle_4: '怎么判断 AI 是不是真的做到了',
    forge_layer_5: '05  文化适配',
    forge_layer_subtitle_5: '换个文化语境该怎么调整',
    forge_ready: '准备铸造',
    forge_proceed: '继续发布 →',
